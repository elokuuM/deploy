...
WORKING_DIRECTORY = 'yolov8n_working'                             # choose your working directory
...
if MODEL_TYPE == NetworkFramework.ONNX:
    graph = load_onnx_graph(onnx_import_file = os.path.join(WORKING_DIRECTORY, 'yolov8n.onnx'))
...
# QS.dispatching_table.append('/encoder/stage2/stage2.9/reparam_conv/Conv', 
#                             TargetPlatform.FP32)
# QS.dispatching_table.append('/encoder/stage2/stage2.9/activation/Relu', 
#                             TargetPlatform.FP32)

# QS.dispatching_table.append('/encoder/stage3/stage3.17/reparam_conv/Conv', 
#                             TargetPlatform.FP32)
# QS.dispatching_table.append('/encoder/stage3/stage3.17/activation/Relu', 
#                             TargetPlatform.FP32)
...
with ENABLE_CUDA_KERNEL():
    ...
    # -------------------------------------------------------------------
    print('正计算网络量化误差(SNR)，最后一层的误差应小于 10% 以保证量化精度:')
    ...
    if REQUIRE_ANALYSE:
        print('正计算逐层量化误差(SNR)，每一层的独立量化误差应小于 10% 以保证量化精度:')
    ...
    export_ppq_graph(
        ...
        config_save_to = os.path.join(WORKING_DIRECTORY, 'quant_cfg.table'))